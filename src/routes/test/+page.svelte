<script>
    ...
    let url = 'https://requirements-api.joinsherpa.com/v2/countries?include=restriction,procedure&language=en-US&filter%5Brestriction.createdAt%5D=2023-07-04&filter%5Bprocedure.createdAt%5D=2023-07-04&key=AIzaSyCd3jDrVQKwFnj_hk3j1gIjkqCghP3c3TY&affiliateId=sherpa'
    let allCountries = [];
